  ...
  if (contactForm) {
    ...
    function clearFieldError(field) {
      ...
      const existingError = field.parentElement
        ? field.parentElement.querySelector('.field-error, .form-error-msg')
        : null;
    ...
    function showFieldError(field, message) {
      ...
      errorEl.className = 'field-error form-error-msg';
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '3ac9ea1d-3eac-4ead-bfc6-40f6383acbf4',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '3ac9ea1d-3eac-4ead-bfc6-40f6383acbf4';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '3ac9ea1d-3eac-4ead-bfc6-40f6383acbf4';
